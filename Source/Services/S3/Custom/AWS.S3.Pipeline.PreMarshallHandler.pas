...
type
  ...
  strict private
    ...
    class procedure ProcessPutBucketRequest(PutBucketRequest: TPutBucketRequest);
    class procedure ProcessDeleteBucketRequest(DeleteBucketRequest: TDeleteBucketRequest);
    class procedure ProcessUploadPartRequest(UploadPartRequest: TUploadPartRequest);
    class procedure ProcessInitiateMultipartUploadRequest(InitiateMultipartUploadRequest: TInitiateMultipartUploadRequest);
  strict protected
...
class procedure TAmazonS3PreMarshallHandler.ProcessDeleteBucketRequest(DeleteBucketRequest: TDeleteBucketRequest);
begin

end;

class procedure TAmazonS3PreMarshallHandler.ProcessInitiateMultipartUploadRequest(
  InitiateMultipartUploadRequest: TInitiateMultipartUploadRequest);
begin
...
begin
  ...
  if request is TPutBucketRequest then
    ProcessPutBucketRequest(request as TPutBucketRequest);

  if request is TDeleteBucketRequest then
    ProcessDeleteBucketRequest(request as TDeleteBucketRequest);
...
class procedure TAmazonS3PreMarshallHandler.ProcessPutBucketRequest(PutBucketRequest: TPutBucketRequest);
begin

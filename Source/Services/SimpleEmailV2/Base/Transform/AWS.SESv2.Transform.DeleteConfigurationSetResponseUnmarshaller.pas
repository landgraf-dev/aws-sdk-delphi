unit AWS.SESv2.Transform.DeleteConfigurationSetResponseUnmarshaller;
...
type
  ...
  TDeleteConfigurationSetResponseUnmarshaller = class(TJsonResponseUnmarshaller, IDeleteConfigurationSetResponseUnmarshaller)
  strict private
...
function TDeleteConfigurationSetResponseUnmarshaller.Unmarshall(AContext: TJsonUnmarshallerContext): TAmazonWebServiceResponse;
var
...
function TDeleteConfigurationSetResponseUnmarshaller.UnmarshallException(AContext: TJsonUnmarshallerContext; AInnerException: Exception; AStatusCode: Integer): EAmazonServiceException;
var

unit AWS.SESv2.Transform.CreateConfigurationSetResponseUnmarshaller;
...
type
  ...
  TCreateConfigurationSetResponseUnmarshaller = class(TJsonResponseUnmarshaller, ICreateConfigurationSetResponseUnmarshaller)
  strict private
...
function TCreateConfigurationSetResponseUnmarshaller.Unmarshall(AContext: TJsonUnmarshallerContext): TAmazonWebServiceResponse;
var
...
function TCreateConfigurationSetResponseUnmarshaller.UnmarshallException(AContext: TJsonUnmarshallerContext; AInnerException: Exception; AStatusCode: Integer): EAmazonServiceException;
var

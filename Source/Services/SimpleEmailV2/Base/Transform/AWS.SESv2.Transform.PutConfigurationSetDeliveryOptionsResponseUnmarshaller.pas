unit AWS.SESv2.Transform.PutConfigurationSetDeliveryOptionsResponseUnmarshaller;
...
type
  ...
  TPutConfigurationSetDeliveryOptionsResponseUnmarshaller = class(TJsonResponseUnmarshaller, IPutConfigurationSetDeliveryOptionsResponseUnmarshaller)
  strict private
...
function TPutConfigurationSetDeliveryOptionsResponseUnmarshaller.Unmarshall(AContext: TJsonUnmarshallerContext): TAmazonWebServiceResponse;
var
...
function TPutConfigurationSetDeliveryOptionsResponseUnmarshaller.UnmarshallException(AContext: TJsonUnmarshallerContext; AInnerException: Exception; AStatusCode: Integer): EAmazonServiceException;
var

unit AWS.Transcribe.Transform.CreateMedicalVocabularyResponseUnmarshaller;
...
type
  ICreateMedicalVocabularyResponseUnmarshaller = IResponseUnmarshaller;
  
  TCreateMedicalVocabularyResponseUnmarshaller = class(TJsonResponseUnmarshaller, ICreateMedicalVocabularyResponseUnmarshaller)
  strict private
    class var FInstance: ICreateMedicalVocabularyResponseUnmarshaller;
    class constructor Create;
  public
    function Unmarshall(AContext: TJsonUnmarshallerContext): TAmazonWebServiceResponse; overload; override;
    function UnmarshallException(AContext: TJsonUnmarshallerContext; AInnerException: Exception; AStatusCode: Integer): EAmazonServiceException; override;
    class function Instance: ICreateMedicalVocabularyResponseUnmarshaller; static;
  end;
  
implementation

{ TCreateMedicalVocabularyResponseUnmarshaller }

function TCreateMedicalVocabularyResponseUnmarshaller.Unmarshall(AContext: TJsonUnmarshallerContext): TAmazonWebServiceResponse;
var
  Response: TCreateMedicalVocabularyResponse;
begin
  Response := TCreateMedicalVocabularyResponse.Create;
  try
    AContext.Read;
...
function TCreateMedicalVocabularyResponseUnmarshaller.UnmarshallException(AContext: TJsonUnmarshallerContext; AInnerException: Exception; AStatusCode: Integer): EAmazonServiceException;
var
...
class constructor TCreateMedicalVocabularyResponseUnmarshaller.Create;
begin
  FInstance := TCreateMedicalVocabularyResponseUnmarshaller.Create;
end;

class function TCreateMedicalVocabularyResponseUnmarshaller.Instance: ICreateMedicalVocabularyResponseUnmarshaller;
begin
  Result := FInstance;
end;

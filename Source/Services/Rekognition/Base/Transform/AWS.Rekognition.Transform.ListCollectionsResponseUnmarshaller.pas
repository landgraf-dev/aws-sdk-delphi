unit AWS.Rekognition.Transform.ListCollectionsResponseUnmarshaller;
...
type
  IListCollectionsResponseUnmarshaller = IResponseUnmarshaller;
  
  TListCollectionsResponseUnmarshaller = class(TJsonResponseUnmarshaller, IListCollectionsResponseUnmarshaller)
  strict private
    class var FInstance: IListCollectionsResponseUnmarshaller;
    class constructor Create;
  public
    function Unmarshall(AContext: TJsonUnmarshallerContext): TAmazonWebServiceResponse; overload; override;
    function UnmarshallException(AContext: TJsonUnmarshallerContext; AInnerException: Exception; AStatusCode: Integer): EAmazonServiceException; override;
    class function Instance: IListCollectionsResponseUnmarshaller; static;
  end;
  
implementation

{ TListCollectionsResponseUnmarshaller }

function TListCollectionsResponseUnmarshaller.Unmarshall(AContext: TJsonUnmarshallerContext): TAmazonWebServiceResponse;
var
  Response: TListCollectionsResponse;
begin
  Response := TListCollectionsResponse.Create;
  try
    AContext.Read;
    var TargetDepth := AContext.CurrentDepth;
    while AContext.ReadAtDepth(TargetDepth) do
    begin
      if AContext.TestExpression('CollectionIds', TargetDepth) then
      begin
        var Unmarshaller := TJsonListUnmarshaller<string, IJsonStringUnmarshaller>.JsonNew(TStringUnmarshaller.JsonInstance);
        Response.CollectionIds := Unmarshaller.Unmarshall(AContext);
        Continue;
      end;
      if AContext.TestExpression('FaceModelVersions', TargetDepth) then
      begin
        var Unmarshaller := TJsonListUnmarshaller<string, IJsonStringUnmarshaller>.JsonNew(TStringUnmarshaller.JsonInstance);
        Response.FaceModelVersions := Unmarshaller.Unmarshall(AContext);
        Continue;
      end;
...
function TListCollectionsResponseUnmarshaller.UnmarshallException(AContext: TJsonUnmarshallerContext; AInnerException: Exception; AStatusCode: Integer): EAmazonServiceException;
var
...
class constructor TListCollectionsResponseUnmarshaller.Create;
begin
  FInstance := TListCollectionsResponseUnmarshaller.Create;
end;

class function TListCollectionsResponseUnmarshaller.Instance: IListCollectionsResponseUnmarshaller;
begin
  Result := FInstance;
end;

unit AWS.Rekognition.Transform.GetLabelDetectionResponseUnmarshaller;
...
uses
  ...
  AWS.Rekognition.Transform.LabelDetectionUnmarshaller, 
...
type
  IGetLabelDetectionResponseUnmarshaller = IResponseUnmarshaller;
  
  TGetLabelDetectionResponseUnmarshaller = class(TJsonResponseUnmarshaller, IGetLabelDetectionResponseUnmarshaller)
  strict private
    class var FInstance: IGetLabelDetectionResponseUnmarshaller;
    class constructor Create;
  public
    function Unmarshall(AContext: TJsonUnmarshallerContext): TAmazonWebServiceResponse; overload; override;
    function UnmarshallException(AContext: TJsonUnmarshallerContext; AInnerException: Exception; AStatusCode: Integer): EAmazonServiceException; override;
    class function Instance: IGetLabelDetectionResponseUnmarshaller; static;
  end;
  
implementation

{ TGetLabelDetectionResponseUnmarshaller }

function TGetLabelDetectionResponseUnmarshaller.Unmarshall(AContext: TJsonUnmarshallerContext): TAmazonWebServiceResponse;
var
  Response: TGetLabelDetectionResponse;
begin
  Response := TGetLabelDetectionResponse.Create;
  try
    AContext.Read;
    ...
    begin
      ...
      begin
        var Unmarshaller := TJsonObjectListUnmarshaller<TLabelDetection, ILabelDetectionUnmarshaller>.JsonNew(TLabelDetectionUnmarshaller.JsonInstance);
...
function TGetLabelDetectionResponseUnmarshaller.UnmarshallException(AContext: TJsonUnmarshallerContext; AInnerException: Exception; AStatusCode: Integer): EAmazonServiceException;
var
...
class constructor TGetLabelDetectionResponseUnmarshaller.Create;
begin
  FInstance := TGetLabelDetectionResponseUnmarshaller.Create;
end;

class function TGetLabelDetectionResponseUnmarshaller.Instance: IGetLabelDetectionResponseUnmarshaller;
begin
  Result := FInstance;
end;

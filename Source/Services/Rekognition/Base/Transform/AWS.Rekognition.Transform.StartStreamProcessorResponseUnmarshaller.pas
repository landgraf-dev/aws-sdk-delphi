unit AWS.Rekognition.Transform.StartStreamProcessorResponseUnmarshaller;
...
type
  IStartStreamProcessorResponseUnmarshaller = IResponseUnmarshaller;
  
  TStartStreamProcessorResponseUnmarshaller = class(TJsonResponseUnmarshaller, IStartStreamProcessorResponseUnmarshaller)
  strict private
    class var FInstance: IStartStreamProcessorResponseUnmarshaller;
    class constructor Create;
  public
    function Unmarshall(AContext: TJsonUnmarshallerContext): TAmazonWebServiceResponse; overload; override;
    function UnmarshallException(AContext: TJsonUnmarshallerContext; AInnerException: Exception; AStatusCode: Integer): EAmazonServiceException; override;
    class function Instance: IStartStreamProcessorResponseUnmarshaller; static;
  end;
  
implementation

{ TStartStreamProcessorResponseUnmarshaller }

function TStartStreamProcessorResponseUnmarshaller.Unmarshall(AContext: TJsonUnmarshallerContext): TAmazonWebServiceResponse;
var
  Response: TStartStreamProcessorResponse;
begin
...
function TStartStreamProcessorResponseUnmarshaller.UnmarshallException(AContext: TJsonUnmarshallerContext; AInnerException: Exception; AStatusCode: Integer): EAmazonServiceException;
var
...
class constructor TStartStreamProcessorResponseUnmarshaller.Create;
begin
  FInstance := TStartStreamProcessorResponseUnmarshaller.Create;
end;

class function TStartStreamProcessorResponseUnmarshaller.Instance: IStartStreamProcessorResponseUnmarshaller;
begin
  Result := FInstance;
end;

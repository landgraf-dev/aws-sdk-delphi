unit AWS.Rekognition.Transform.StartFaceSearchResponseUnmarshaller;
...
type
  IStartFaceSearchResponseUnmarshaller = IResponseUnmarshaller;
  
  TStartFaceSearchResponseUnmarshaller = class(TJsonResponseUnmarshaller, IStartFaceSearchResponseUnmarshaller)
  strict private
    class var FInstance: IStartFaceSearchResponseUnmarshaller;
    class constructor Create;
  public
    function Unmarshall(AContext: TJsonUnmarshallerContext): TAmazonWebServiceResponse; overload; override;
    function UnmarshallException(AContext: TJsonUnmarshallerContext; AInnerException: Exception; AStatusCode: Integer): EAmazonServiceException; override;
    class function Instance: IStartFaceSearchResponseUnmarshaller; static;
  end;
  
implementation

{ TStartFaceSearchResponseUnmarshaller }

function TStartFaceSearchResponseUnmarshaller.Unmarshall(AContext: TJsonUnmarshallerContext): TAmazonWebServiceResponse;
var
  Response: TStartFaceSearchResponse;
begin
  Response := TStartFaceSearchResponse.Create;
  try
    AContext.Read;
...
function TStartFaceSearchResponseUnmarshaller.UnmarshallException(AContext: TJsonUnmarshallerContext; AInnerException: Exception; AStatusCode: Integer): EAmazonServiceException;
var
...
class constructor TStartFaceSearchResponseUnmarshaller.Create;
begin
  FInstance := TStartFaceSearchResponseUnmarshaller.Create;
end;

class function TStartFaceSearchResponseUnmarshaller.Instance: IStartFaceSearchResponseUnmarshaller;
begin
  Result := FInstance;
end;

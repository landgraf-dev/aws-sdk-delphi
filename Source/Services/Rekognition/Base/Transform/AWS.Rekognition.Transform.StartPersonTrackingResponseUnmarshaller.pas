unit AWS.Rekognition.Transform.StartPersonTrackingResponseUnmarshaller;
...
type
  IStartPersonTrackingResponseUnmarshaller = IResponseUnmarshaller;
  
  TStartPersonTrackingResponseUnmarshaller = class(TJsonResponseUnmarshaller, IStartPersonTrackingResponseUnmarshaller)
  strict private
    class var FInstance: IStartPersonTrackingResponseUnmarshaller;
    class constructor Create;
  public
    function Unmarshall(AContext: TJsonUnmarshallerContext): TAmazonWebServiceResponse; overload; override;
    function UnmarshallException(AContext: TJsonUnmarshallerContext; AInnerException: Exception; AStatusCode: Integer): EAmazonServiceException; override;
    class function Instance: IStartPersonTrackingResponseUnmarshaller; static;
  end;
  
implementation

{ TStartPersonTrackingResponseUnmarshaller }

function TStartPersonTrackingResponseUnmarshaller.Unmarshall(AContext: TJsonUnmarshallerContext): TAmazonWebServiceResponse;
var
  Response: TStartPersonTrackingResponse;
begin
  Response := TStartPersonTrackingResponse.Create;
  try
    AContext.Read;
...
function TStartPersonTrackingResponseUnmarshaller.UnmarshallException(AContext: TJsonUnmarshallerContext; AInnerException: Exception; AStatusCode: Integer): EAmazonServiceException;
var
...
class constructor TStartPersonTrackingResponseUnmarshaller.Create;
begin
  FInstance := TStartPersonTrackingResponseUnmarshaller.Create;
end;

class function TStartPersonTrackingResponseUnmarshaller.Instance: IStartPersonTrackingResponseUnmarshaller;
begin
  Result := FInstance;
end;

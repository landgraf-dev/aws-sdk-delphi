unit AWS.Rekognition.Transform.DeleteProjectVersionResponseUnmarshaller;
...
type
  IDeleteProjectVersionResponseUnmarshaller = IResponseUnmarshaller;
  
  TDeleteProjectVersionResponseUnmarshaller = class(TJsonResponseUnmarshaller, IDeleteProjectVersionResponseUnmarshaller)
  strict private
    class var FInstance: IDeleteProjectVersionResponseUnmarshaller;
    class constructor Create;
  public
    function Unmarshall(AContext: TJsonUnmarshallerContext): TAmazonWebServiceResponse; overload; override;
    function UnmarshallException(AContext: TJsonUnmarshallerContext; AInnerException: Exception; AStatusCode: Integer): EAmazonServiceException; override;
    class function Instance: IDeleteProjectVersionResponseUnmarshaller; static;
  end;
  
implementation

{ TDeleteProjectVersionResponseUnmarshaller }

function TDeleteProjectVersionResponseUnmarshaller.Unmarshall(AContext: TJsonUnmarshallerContext): TAmazonWebServiceResponse;
var
  Response: TDeleteProjectVersionResponse;
begin
  Response := TDeleteProjectVersionResponse.Create;
  try
    AContext.Read;
...
function TDeleteProjectVersionResponseUnmarshaller.UnmarshallException(AContext: TJsonUnmarshallerContext; AInnerException: Exception; AStatusCode: Integer): EAmazonServiceException;
var
...
class constructor TDeleteProjectVersionResponseUnmarshaller.Create;
begin
  FInstance := TDeleteProjectVersionResponseUnmarshaller.Create;
end;

class function TDeleteProjectVersionResponseUnmarshaller.Instance: IDeleteProjectVersionResponseUnmarshaller;
begin
  Result := FInstance;
end;

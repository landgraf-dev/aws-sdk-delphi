unit AWS.Rekognition.Transform.StartProjectVersionResponseUnmarshaller;
...
type
  IStartProjectVersionResponseUnmarshaller = IResponseUnmarshaller;
  
  TStartProjectVersionResponseUnmarshaller = class(TJsonResponseUnmarshaller, IStartProjectVersionResponseUnmarshaller)
  strict private
    class var FInstance: IStartProjectVersionResponseUnmarshaller;
    class constructor Create;
  public
    function Unmarshall(AContext: TJsonUnmarshallerContext): TAmazonWebServiceResponse; overload; override;
    function UnmarshallException(AContext: TJsonUnmarshallerContext; AInnerException: Exception; AStatusCode: Integer): EAmazonServiceException; override;
    class function Instance: IStartProjectVersionResponseUnmarshaller; static;
  end;
  
implementation

{ TStartProjectVersionResponseUnmarshaller }

function TStartProjectVersionResponseUnmarshaller.Unmarshall(AContext: TJsonUnmarshallerContext): TAmazonWebServiceResponse;
var
  Response: TStartProjectVersionResponse;
begin
  Response := TStartProjectVersionResponse.Create;
  try
    AContext.Read;
...
function TStartProjectVersionResponseUnmarshaller.UnmarshallException(AContext: TJsonUnmarshallerContext; AInnerException: Exception; AStatusCode: Integer): EAmazonServiceException;
var
...
class constructor TStartProjectVersionResponseUnmarshaller.Create;
begin
  FInstance := TStartProjectVersionResponseUnmarshaller.Create;
end;

class function TStartProjectVersionResponseUnmarshaller.Instance: IStartProjectVersionResponseUnmarshaller;
begin
  Result := FInstance;
end;

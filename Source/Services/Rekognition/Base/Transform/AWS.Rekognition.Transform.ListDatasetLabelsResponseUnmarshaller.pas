unit AWS.Rekognition.Transform.ListDatasetLabelsResponseUnmarshaller;
...
uses
  ...
  AWS.Rekognition.Transform.DatasetLabelDescriptionUnmarshaller, 
...
type
  IListDatasetLabelsResponseUnmarshaller = IResponseUnmarshaller;
  
  TListDatasetLabelsResponseUnmarshaller = class(TJsonResponseUnmarshaller, IListDatasetLabelsResponseUnmarshaller)
  strict private
    class var FInstance: IListDatasetLabelsResponseUnmarshaller;
    class constructor Create;
  public
    function Unmarshall(AContext: TJsonUnmarshallerContext): TAmazonWebServiceResponse; overload; override;
    function UnmarshallException(AContext: TJsonUnmarshallerContext; AInnerException: Exception; AStatusCode: Integer): EAmazonServiceException; override;
    class function Instance: IListDatasetLabelsResponseUnmarshaller; static;
  end;
  
implementation

{ TListDatasetLabelsResponseUnmarshaller }

function TListDatasetLabelsResponseUnmarshaller.Unmarshall(AContext: TJsonUnmarshallerContext): TAmazonWebServiceResponse;
var
  Response: TListDatasetLabelsResponse;
begin
  Response := TListDatasetLabelsResponse.Create;
  try
    AContext.Read;
    var TargetDepth := AContext.CurrentDepth;
    while AContext.ReadAtDepth(TargetDepth) do
    begin
      if AContext.TestExpression('DatasetLabelDescriptions', TargetDepth) then
      begin
        var Unmarshaller := TJsonObjectListUnmarshaller<TDatasetLabelDescription, IDatasetLabelDescriptionUnmarshaller>.JsonNew(TDatasetLabelDescriptionUnmarshaller.JsonInstance);
        Response.DatasetLabelDescriptions := Unmarshaller.Unmarshall(AContext);
        Continue;
      end;
...
function TListDatasetLabelsResponseUnmarshaller.UnmarshallException(AContext: TJsonUnmarshallerContext; AInnerException: Exception; AStatusCode: Integer): EAmazonServiceException;
var
...
class constructor TListDatasetLabelsResponseUnmarshaller.Create;
begin
  FInstance := TListDatasetLabelsResponseUnmarshaller.Create;
end;

class function TListDatasetLabelsResponseUnmarshaller.Instance: IListDatasetLabelsResponseUnmarshaller;
begin
  Result := FInstance;
end;

unit AWS.Rekognition.Transform.StopProjectVersionResponseUnmarshaller;
...
type
  IStopProjectVersionResponseUnmarshaller = IResponseUnmarshaller;
  
  TStopProjectVersionResponseUnmarshaller = class(TJsonResponseUnmarshaller, IStopProjectVersionResponseUnmarshaller)
  strict private
    class var FInstance: IStopProjectVersionResponseUnmarshaller;
    class constructor Create;
  public
    function Unmarshall(AContext: TJsonUnmarshallerContext): TAmazonWebServiceResponse; overload; override;
    function UnmarshallException(AContext: TJsonUnmarshallerContext; AInnerException: Exception; AStatusCode: Integer): EAmazonServiceException; override;
    class function Instance: IStopProjectVersionResponseUnmarshaller; static;
  end;
  
implementation

{ TStopProjectVersionResponseUnmarshaller }

function TStopProjectVersionResponseUnmarshaller.Unmarshall(AContext: TJsonUnmarshallerContext): TAmazonWebServiceResponse;
var
  Response: TStopProjectVersionResponse;
begin
  Response := TStopProjectVersionResponse.Create;
  try
    AContext.Read;
...
function TStopProjectVersionResponseUnmarshaller.UnmarshallException(AContext: TJsonUnmarshallerContext; AInnerException: Exception; AStatusCode: Integer): EAmazonServiceException;
var
...
class constructor TStopProjectVersionResponseUnmarshaller.Create;
begin
  FInstance := TStopProjectVersionResponseUnmarshaller.Create;
end;

class function TStopProjectVersionResponseUnmarshaller.Instance: IStopProjectVersionResponseUnmarshaller;
begin
  Result := FInstance;
end;

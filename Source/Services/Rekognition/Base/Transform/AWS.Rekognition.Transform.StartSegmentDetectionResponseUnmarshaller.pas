unit AWS.Rekognition.Transform.StartSegmentDetectionResponseUnmarshaller;
...
type
  IStartSegmentDetectionResponseUnmarshaller = IResponseUnmarshaller;
  
  TStartSegmentDetectionResponseUnmarshaller = class(TJsonResponseUnmarshaller, IStartSegmentDetectionResponseUnmarshaller)
  strict private
    class var FInstance: IStartSegmentDetectionResponseUnmarshaller;
    class constructor Create;
  public
    function Unmarshall(AContext: TJsonUnmarshallerContext): TAmazonWebServiceResponse; overload; override;
    function UnmarshallException(AContext: TJsonUnmarshallerContext; AInnerException: Exception; AStatusCode: Integer): EAmazonServiceException; override;
    class function Instance: IStartSegmentDetectionResponseUnmarshaller; static;
  end;
  
implementation

{ TStartSegmentDetectionResponseUnmarshaller }

function TStartSegmentDetectionResponseUnmarshaller.Unmarshall(AContext: TJsonUnmarshallerContext): TAmazonWebServiceResponse;
var
  Response: TStartSegmentDetectionResponse;
begin
  Response := TStartSegmentDetectionResponse.Create;
  try
    AContext.Read;
...
function TStartSegmentDetectionResponseUnmarshaller.UnmarshallException(AContext: TJsonUnmarshallerContext; AInnerException: Exception; AStatusCode: Integer): EAmazonServiceException;
var
...
class constructor TStartSegmentDetectionResponseUnmarshaller.Create;
begin
  FInstance := TStartSegmentDetectionResponseUnmarshaller.Create;
end;

class function TStartSegmentDetectionResponseUnmarshaller.Instance: IStartSegmentDetectionResponseUnmarshaller;
begin
  Result := FInstance;
end;

unit AWS.Rekognition.Transform.DeleteDatasetResponseUnmarshaller;
...
type
  IDeleteDatasetResponseUnmarshaller = IResponseUnmarshaller;
  
  TDeleteDatasetResponseUnmarshaller = class(TJsonResponseUnmarshaller, IDeleteDatasetResponseUnmarshaller)
  strict private
    class var FInstance: IDeleteDatasetResponseUnmarshaller;
    class constructor Create;
  public
    function Unmarshall(AContext: TJsonUnmarshallerContext): TAmazonWebServiceResponse; overload; override;
    function UnmarshallException(AContext: TJsonUnmarshallerContext; AInnerException: Exception; AStatusCode: Integer): EAmazonServiceException; override;
    class function Instance: IDeleteDatasetResponseUnmarshaller; static;
  end;
  
implementation

{ TDeleteDatasetResponseUnmarshaller }

function TDeleteDatasetResponseUnmarshaller.Unmarshall(AContext: TJsonUnmarshallerContext): TAmazonWebServiceResponse;
var
  Response: TDeleteDatasetResponse;
begin
  Response := TDeleteDatasetResponse.Create;
  try
    Result := Response;
    Response := nil;
  finally
...
function TDeleteDatasetResponseUnmarshaller.UnmarshallException(AContext: TJsonUnmarshallerContext; AInnerException: Exception; AStatusCode: Integer): EAmazonServiceException;
var
...
class constructor TDeleteDatasetResponseUnmarshaller.Create;
begin
  FInstance := TDeleteDatasetResponseUnmarshaller.Create;
end;

class function TDeleteDatasetResponseUnmarshaller.Instance: IDeleteDatasetResponseUnmarshaller;
begin
  Result := FInstance;
end;

unit AWS.Rekognition.Transform.CreateProjectResponseUnmarshaller;
...
type
  ICreateProjectResponseUnmarshaller = IResponseUnmarshaller;
  
  TCreateProjectResponseUnmarshaller = class(TJsonResponseUnmarshaller, ICreateProjectResponseUnmarshaller)
  strict private
    class var FInstance: ICreateProjectResponseUnmarshaller;
    class constructor Create;
  public
    function Unmarshall(AContext: TJsonUnmarshallerContext): TAmazonWebServiceResponse; overload; override;
    function UnmarshallException(AContext: TJsonUnmarshallerContext; AInnerException: Exception; AStatusCode: Integer): EAmazonServiceException; override;
    class function Instance: ICreateProjectResponseUnmarshaller; static;
  end;
  
implementation

{ TCreateProjectResponseUnmarshaller }

function TCreateProjectResponseUnmarshaller.Unmarshall(AContext: TJsonUnmarshallerContext): TAmazonWebServiceResponse;
var
  Response: TCreateProjectResponse;
begin
  Response := TCreateProjectResponse.Create;
  try
    AContext.Read;
    ...
    while AContext.ReadAtDepth(TargetDepth) do
      ...
      begin
        ...
        Response.ProjectArn := Unmarshaller.Unmarshall(AContext);
        Continue;
      end;
    Result := Response;
    Response := nil;
...
function TCreateProjectResponseUnmarshaller.UnmarshallException(AContext: TJsonUnmarshallerContext; AInnerException: Exception; AStatusCode: Integer): EAmazonServiceException;
var
...
class constructor TCreateProjectResponseUnmarshaller.Create;
begin
  FInstance := TCreateProjectResponseUnmarshaller.Create;
end;

class function TCreateProjectResponseUnmarshaller.Instance: ICreateProjectResponseUnmarshaller;
begin
  Result := FInstance;
end;

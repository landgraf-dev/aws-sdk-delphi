unit AWS.Rekognition.Transform.DescribeProjectVersionsResponseUnmarshaller;
...
uses
  ...
  AWS.Rekognition.Transform.ProjectVersionDescriptionUnmarshaller, 
...
type
  IDescribeProjectVersionsResponseUnmarshaller = IResponseUnmarshaller;
  
  TDescribeProjectVersionsResponseUnmarshaller = class(TJsonResponseUnmarshaller, IDescribeProjectVersionsResponseUnmarshaller)
  strict private
    class var FInstance: IDescribeProjectVersionsResponseUnmarshaller;
    class constructor Create;
  public
    function Unmarshall(AContext: TJsonUnmarshallerContext): TAmazonWebServiceResponse; overload; override;
    function UnmarshallException(AContext: TJsonUnmarshallerContext; AInnerException: Exception; AStatusCode: Integer): EAmazonServiceException; override;
    class function Instance: IDescribeProjectVersionsResponseUnmarshaller; static;
  end;
  
implementation

{ TDescribeProjectVersionsResponseUnmarshaller }

function TDescribeProjectVersionsResponseUnmarshaller.Unmarshall(AContext: TJsonUnmarshallerContext): TAmazonWebServiceResponse;
var
  Response: TDescribeProjectVersionsResponse;
begin
  Response := TDescribeProjectVersionsResponse.Create;
  try
    AContext.Read;
    ...
    begin
      ...
      if AContext.TestExpression('ProjectVersionDescriptions', TargetDepth) then
      begin
        var Unmarshaller := TJsonObjectListUnmarshaller<TProjectVersionDescription, IProjectVersionDescriptionUnmarshaller>.JsonNew(TProjectVersionDescriptionUnmarshaller.JsonInstance);
        Response.ProjectVersionDescriptions := Unmarshaller.Unmarshall(AContext);
        Continue;
      end;
    end;
    Result := Response;
...
function TDescribeProjectVersionsResponseUnmarshaller.UnmarshallException(AContext: TJsonUnmarshallerContext; AInnerException: Exception; AStatusCode: Integer): EAmazonServiceException;
var
...
class constructor TDescribeProjectVersionsResponseUnmarshaller.Create;
begin
  FInstance := TDescribeProjectVersionsResponseUnmarshaller.Create;
end;

class function TDescribeProjectVersionsResponseUnmarshaller.Instance: IDescribeProjectVersionsResponseUnmarshaller;
begin
  Result := FInstance;
end;

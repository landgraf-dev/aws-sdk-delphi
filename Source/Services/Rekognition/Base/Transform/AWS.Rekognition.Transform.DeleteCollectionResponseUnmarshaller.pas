unit AWS.Rekognition.Transform.DeleteCollectionResponseUnmarshaller;
...
type
  IDeleteCollectionResponseUnmarshaller = IResponseUnmarshaller;
  
  TDeleteCollectionResponseUnmarshaller = class(TJsonResponseUnmarshaller, IDeleteCollectionResponseUnmarshaller)
  strict private
    class var FInstance: IDeleteCollectionResponseUnmarshaller;
    class constructor Create;
  public
    function Unmarshall(AContext: TJsonUnmarshallerContext): TAmazonWebServiceResponse; overload; override;
    function UnmarshallException(AContext: TJsonUnmarshallerContext; AInnerException: Exception; AStatusCode: Integer): EAmazonServiceException; override;
    class function Instance: IDeleteCollectionResponseUnmarshaller; static;
  end;
  
implementation

{ TDeleteCollectionResponseUnmarshaller }

function TDeleteCollectionResponseUnmarshaller.Unmarshall(AContext: TJsonUnmarshallerContext): TAmazonWebServiceResponse;
var
  Response: TDeleteCollectionResponse;
begin
  Response := TDeleteCollectionResponse.Create;
  try
    AContext.Read;
...
function TDeleteCollectionResponseUnmarshaller.UnmarshallException(AContext: TJsonUnmarshallerContext; AInnerException: Exception; AStatusCode: Integer): EAmazonServiceException;
var
...
class constructor TDeleteCollectionResponseUnmarshaller.Create;
begin
  FInstance := TDeleteCollectionResponseUnmarshaller.Create;
end;

class function TDeleteCollectionResponseUnmarshaller.Instance: IDeleteCollectionResponseUnmarshaller;
begin
  Result := FInstance;
end;

unit AWS.Rekognition.Transform.GetCelebrityRecognitionResponseUnmarshaller;
...
uses
  ...
  AWS.Rekognition.Transform.CelebrityRecognitionUnmarshaller, 
...
type
  IGetCelebrityRecognitionResponseUnmarshaller = IResponseUnmarshaller;
  
  TGetCelebrityRecognitionResponseUnmarshaller = class(TJsonResponseUnmarshaller, IGetCelebrityRecognitionResponseUnmarshaller)
  strict private
    class var FInstance: IGetCelebrityRecognitionResponseUnmarshaller;
    class constructor Create;
  public
    function Unmarshall(AContext: TJsonUnmarshallerContext): TAmazonWebServiceResponse; overload; override;
    function UnmarshallException(AContext: TJsonUnmarshallerContext; AInnerException: Exception; AStatusCode: Integer): EAmazonServiceException; override;
    class function Instance: IGetCelebrityRecognitionResponseUnmarshaller; static;
  end;
  
implementation

{ TGetCelebrityRecognitionResponseUnmarshaller }

function TGetCelebrityRecognitionResponseUnmarshaller.Unmarshall(AContext: TJsonUnmarshallerContext): TAmazonWebServiceResponse;
var
  Response: TGetCelebrityRecognitionResponse;
begin
  Response := TGetCelebrityRecognitionResponse.Create;
  try
    AContext.Read;
    var TargetDepth := AContext.CurrentDepth;
    while AContext.ReadAtDepth(TargetDepth) do
    begin
      if AContext.TestExpression('Celebrities', TargetDepth) then
      begin
        var Unmarshaller := TJsonObjectListUnmarshaller<TCelebrityRecognition, ICelebrityRecognitionUnmarshaller>.JsonNew(TCelebrityRecognitionUnmarshaller.JsonInstance);
        Response.Celebrities := Unmarshaller.Unmarshall(AContext);
        Continue;
      end;
...
function TGetCelebrityRecognitionResponseUnmarshaller.UnmarshallException(AContext: TJsonUnmarshallerContext; AInnerException: Exception; AStatusCode: Integer): EAmazonServiceException;
var
...
class constructor TGetCelebrityRecognitionResponseUnmarshaller.Create;
begin
  FInstance := TGetCelebrityRecognitionResponseUnmarshaller.Create;
end;

class function TGetCelebrityRecognitionResponseUnmarshaller.Instance: IGetCelebrityRecognitionResponseUnmarshaller;
begin
  Result := FInstance;
end;

unit AWS.Rekognition.Transform.ListFacesResponseUnmarshaller;
...
type
  IListFacesResponseUnmarshaller = IResponseUnmarshaller;
  
  TListFacesResponseUnmarshaller = class(TJsonResponseUnmarshaller, IListFacesResponseUnmarshaller)
  strict private
    class var FInstance: IListFacesResponseUnmarshaller;
    class constructor Create;
  public
    function Unmarshall(AContext: TJsonUnmarshallerContext): TAmazonWebServiceResponse; overload; override;
    function UnmarshallException(AContext: TJsonUnmarshallerContext; AInnerException: Exception; AStatusCode: Integer): EAmazonServiceException; override;
    class function Instance: IListFacesResponseUnmarshaller; static;
  end;
  
implementation

{ TListFacesResponseUnmarshaller }

function TListFacesResponseUnmarshaller.Unmarshall(AContext: TJsonUnmarshallerContext): TAmazonWebServiceResponse;
var
  Response: TListFacesResponse;
begin
  Response := TListFacesResponse.Create;
  try
    AContext.Read;
    ...
    begin
      ...
      begin
        var Unmarshaller := TJsonObjectListUnmarshaller<TFace, IFaceUnmarshaller>.JsonNew(TFaceUnmarshaller.JsonInstance);
...
function TListFacesResponseUnmarshaller.UnmarshallException(AContext: TJsonUnmarshallerContext; AInnerException: Exception; AStatusCode: Integer): EAmazonServiceException;
var
...
class constructor TListFacesResponseUnmarshaller.Create;
begin
  FInstance := TListFacesResponseUnmarshaller.Create;
end;

class function TListFacesResponseUnmarshaller.Instance: IListFacesResponseUnmarshaller;
begin
  Result := FInstance;
end;

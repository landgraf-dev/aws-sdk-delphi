unit AWS.Rekognition.Transform.StartTextDetectionResponseUnmarshaller;
...
type
  IStartTextDetectionResponseUnmarshaller = IResponseUnmarshaller;
  
  TStartTextDetectionResponseUnmarshaller = class(TJsonResponseUnmarshaller, IStartTextDetectionResponseUnmarshaller)
  strict private
    class var FInstance: IStartTextDetectionResponseUnmarshaller;
    class constructor Create;
  public
    function Unmarshall(AContext: TJsonUnmarshallerContext): TAmazonWebServiceResponse; overload; override;
    function UnmarshallException(AContext: TJsonUnmarshallerContext; AInnerException: Exception; AStatusCode: Integer): EAmazonServiceException; override;
    class function Instance: IStartTextDetectionResponseUnmarshaller; static;
  end;
  
implementation

{ TStartTextDetectionResponseUnmarshaller }

function TStartTextDetectionResponseUnmarshaller.Unmarshall(AContext: TJsonUnmarshallerContext): TAmazonWebServiceResponse;
var
  Response: TStartTextDetectionResponse;
begin
  Response := TStartTextDetectionResponse.Create;
  try
    AContext.Read;
...
function TStartTextDetectionResponseUnmarshaller.UnmarshallException(AContext: TJsonUnmarshallerContext; AInnerException: Exception; AStatusCode: Integer): EAmazonServiceException;
var
...
class constructor TStartTextDetectionResponseUnmarshaller.Create;
begin
  FInstance := TStartTextDetectionResponseUnmarshaller.Create;
end;

class function TStartTextDetectionResponseUnmarshaller.Instance: IStartTextDetectionResponseUnmarshaller;
begin
  Result := FInstance;
end;

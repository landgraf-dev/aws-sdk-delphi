unit AWS.Rekognition.Transform.StartCelebrityRecognitionResponseUnmarshaller;
...
type
  IStartCelebrityRecognitionResponseUnmarshaller = IResponseUnmarshaller;
  
  TStartCelebrityRecognitionResponseUnmarshaller = class(TJsonResponseUnmarshaller, IStartCelebrityRecognitionResponseUnmarshaller)
  strict private
    class var FInstance: IStartCelebrityRecognitionResponseUnmarshaller;
    class constructor Create;
  public
    function Unmarshall(AContext: TJsonUnmarshallerContext): TAmazonWebServiceResponse; overload; override;
    function UnmarshallException(AContext: TJsonUnmarshallerContext; AInnerException: Exception; AStatusCode: Integer): EAmazonServiceException; override;
    class function Instance: IStartCelebrityRecognitionResponseUnmarshaller; static;
  end;
  
implementation

{ TStartCelebrityRecognitionResponseUnmarshaller }

function TStartCelebrityRecognitionResponseUnmarshaller.Unmarshall(AContext: TJsonUnmarshallerContext): TAmazonWebServiceResponse;
var
  Response: TStartCelebrityRecognitionResponse;
begin
  Response := TStartCelebrityRecognitionResponse.Create;
  try
    AContext.Read;
...
function TStartCelebrityRecognitionResponseUnmarshaller.UnmarshallException(AContext: TJsonUnmarshallerContext; AInnerException: Exception; AStatusCode: Integer): EAmazonServiceException;
var
...
class constructor TStartCelebrityRecognitionResponseUnmarshaller.Create;
begin
  FInstance := TStartCelebrityRecognitionResponseUnmarshaller.Create;
end;

class function TStartCelebrityRecognitionResponseUnmarshaller.Instance: IStartCelebrityRecognitionResponseUnmarshaller;
begin
  Result := FInstance;
end;

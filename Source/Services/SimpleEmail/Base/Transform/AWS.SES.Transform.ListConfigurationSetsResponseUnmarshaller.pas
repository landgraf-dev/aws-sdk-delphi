unit AWS.SES.Transform.ListConfigurationSetsResponseUnmarshaller;
...
type
  ...
  TListConfigurationSetsResponseUnmarshaller = class(TXmlResponseUnmarshaller, IListConfigurationSetsResponseUnmarshaller)
  strict private
    class var FInstance: IListConfigurationSetsResponseUnmarshaller;
    class procedure UnmarshallResult(AContext: TXmlUnmarshallerContext; AResponse: TListConfigurationSetsResponse); static;
...
function TListConfigurationSetsResponseUnmarshaller.Unmarshall(AContext: TXmlUnmarshallerContext): TAmazonWebServiceResponse;
var
...
begin
  ...
  try
    ...
    while AContext.ReadAtDepth(TargetDepth) do
      ...
      begin
        if AContext.TestExpression('ListConfigurationSetsResult', 2) then
        begin
...
class procedure TListConfigurationSetsResponseUnmarshaller.UnmarshallResult(AContext: TXmlUnmarshallerContext; AResponse: TListConfigurationSetsResponse);
var
...
begin
  ...
  while AContext.ReadAtDepth(OriginalDepth) do
    ...
    begin
      if AContext.TestExpression('ConfigurationSets/member', TargetDepth) then
      begin
        var Unmarshaller := TConfigurationSetUnmarshaller.Instance;
        AResponse.ConfigurationSets.Add(Unmarshaller.Unmarshall(AContext));
        Continue;
      end;
...
function TListConfigurationSetsResponseUnmarshaller.UnmarshallException(AContext: TXmlUnmarshallerContext; AInnerException: Exception; AStatusCode: Integer): EAmazonServiceException;
var

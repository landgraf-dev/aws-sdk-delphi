unit AWS.SES.Transform.GetCustomVerificationEmailTemplateResponseUnmarshaller;
...
type
  ...
  TGetCustomVerificationEmailTemplateResponseUnmarshaller = class(TXmlResponseUnmarshaller, IGetCustomVerificationEmailTemplateResponseUnmarshaller)
  strict private
    class var FInstance: IGetCustomVerificationEmailTemplateResponseUnmarshaller;
    class procedure UnmarshallResult(AContext: TXmlUnmarshallerContext; AResponse: TGetCustomVerificationEmailTemplateResponse); static;
...
function TGetCustomVerificationEmailTemplateResponseUnmarshaller.Unmarshall(AContext: TXmlUnmarshallerContext): TAmazonWebServiceResponse;
var
...
begin
  ...
  try
    ...
    while AContext.ReadAtDepth(TargetDepth) do
      ...
      begin
        if AContext.TestExpression('GetCustomVerificationEmailTemplateResult', 2) then
        begin
...
class procedure TGetCustomVerificationEmailTemplateResponseUnmarshaller.UnmarshallResult(AContext: TXmlUnmarshallerContext; AResponse: TGetCustomVerificationEmailTemplateResponse);
var
  ...
  while AContext.ReadAtDepth(OriginalDepth) do
    ...
    begin
      ...
      begin
        ...
        AResponse.FailureRedirectionURL := Unmarshaller.Unmarshall(AContext);
        Continue;
      end;
      if AContext.TestExpression('FromEmailAddress', TargetDepth) then
      begin
        var Unmarshaller := TStringUnmarshaller.Instance;
        AResponse.FromEmailAddress := Unmarshaller.Unmarshall(AContext);
        Continue;
      end;
      if AContext.TestExpression('SuccessRedirectionURL', TargetDepth) then
      begin
        var Unmarshaller := TStringUnmarshaller.Instance;
        AResponse.SuccessRedirectionURL := Unmarshaller.Unmarshall(AContext);
        Continue;
      end;
      if AContext.TestExpression('TemplateContent', TargetDepth) then
      begin
        var Unmarshaller := TStringUnmarshaller.Instance;
        AResponse.TemplateContent := Unmarshaller.Unmarshall(AContext);
        Continue;
      end;
      if AContext.TestExpression('TemplateName', TargetDepth) then
      begin
        var Unmarshaller := TStringUnmarshaller.Instance;
        AResponse.TemplateName := Unmarshaller.Unmarshall(AContext);
        Continue;
      end;
      if AContext.TestExpression('TemplateSubject', TargetDepth) then
      begin
        var Unmarshaller := TStringUnmarshaller.Instance;
        AResponse.TemplateSubject := Unmarshaller.Unmarshall(AContext);
        Continue;
      end;
    end;
end;

function TGetCustomVerificationEmailTemplateResponseUnmarshaller.UnmarshallException(AContext: TXmlUnmarshallerContext; AInnerException: Exception; AStatusCode: Integer): EAmazonServiceException;
var

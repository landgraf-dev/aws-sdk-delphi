unit AWS.SES.Model.UpdateCustomVerificationEmailTemplateRequest;
...
type
  ...
  TUpdateCustomVerificationEmailTemplateRequest = class(TAmazonSimpleEmailServiceRequest, IUpdateCustomVerificationEmailTemplateRequest)
  strict private

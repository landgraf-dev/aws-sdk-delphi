unit AWS.SES.Model.CreateCustomVerificationEmailTemplateRequest;
...
type
  ...
  TCreateCustomVerificationEmailTemplateRequest = class(TAmazonSimpleEmailServiceRequest, ICreateCustomVerificationEmailTemplateRequest)
  strict private

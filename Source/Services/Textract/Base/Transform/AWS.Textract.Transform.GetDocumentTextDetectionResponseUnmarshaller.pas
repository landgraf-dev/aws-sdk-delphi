unit AWS.Textract.Transform.GetDocumentTextDetectionResponseUnmarshaller;
...
type
  IGetDocumentTextDetectionResponseUnmarshaller = IResponseUnmarshaller;
  
  TGetDocumentTextDetectionResponseUnmarshaller = class(TJsonResponseUnmarshaller, IGetDocumentTextDetectionResponseUnmarshaller)
  strict private
    class var FInstance: IGetDocumentTextDetectionResponseUnmarshaller;
    class constructor Create;
  public
    function Unmarshall(AContext: TJsonUnmarshallerContext): TAmazonWebServiceResponse; overload; override;
    function UnmarshallException(AContext: TJsonUnmarshallerContext; AInnerException: Exception; AStatusCode: Integer): EAmazonServiceException; override;
    class function Instance: IGetDocumentTextDetectionResponseUnmarshaller; static;
  end;
  
implementation

{ TGetDocumentTextDetectionResponseUnmarshaller }

function TGetDocumentTextDetectionResponseUnmarshaller.Unmarshall(AContext: TJsonUnmarshallerContext): TAmazonWebServiceResponse;
var
  Response: TGetDocumentTextDetectionResponse;
begin
  Response := TGetDocumentTextDetectionResponse.Create;
  try
    AContext.Read;
...
function TGetDocumentTextDetectionResponseUnmarshaller.UnmarshallException(AContext: TJsonUnmarshallerContext; AInnerException: Exception; AStatusCode: Integer): EAmazonServiceException;
var
...
class constructor TGetDocumentTextDetectionResponseUnmarshaller.Create;
begin
  FInstance := TGetDocumentTextDetectionResponseUnmarshaller.Create;
end;

class function TGetDocumentTextDetectionResponseUnmarshaller.Instance: IGetDocumentTextDetectionResponseUnmarshaller;
begin
  Result := FInstance;
end;

unit AWS.Textract.Transform.StartExpenseAnalysisResponseUnmarshaller;
...
type
  IStartExpenseAnalysisResponseUnmarshaller = IResponseUnmarshaller;
  
  TStartExpenseAnalysisResponseUnmarshaller = class(TJsonResponseUnmarshaller, IStartExpenseAnalysisResponseUnmarshaller)
  strict private
    class var FInstance: IStartExpenseAnalysisResponseUnmarshaller;
    class constructor Create;
  public
    function Unmarshall(AContext: TJsonUnmarshallerContext): TAmazonWebServiceResponse; overload; override;
    function UnmarshallException(AContext: TJsonUnmarshallerContext; AInnerException: Exception; AStatusCode: Integer): EAmazonServiceException; override;
    class function Instance: IStartExpenseAnalysisResponseUnmarshaller; static;
  end;
  
implementation

{ TStartExpenseAnalysisResponseUnmarshaller }

function TStartExpenseAnalysisResponseUnmarshaller.Unmarshall(AContext: TJsonUnmarshallerContext): TAmazonWebServiceResponse;
var
  Response: TStartExpenseAnalysisResponse;
begin
  Response := TStartExpenseAnalysisResponse.Create;
  try
    AContext.Read;
...
function TStartExpenseAnalysisResponseUnmarshaller.UnmarshallException(AContext: TJsonUnmarshallerContext; AInnerException: Exception; AStatusCode: Integer): EAmazonServiceException;
var
...
class constructor TStartExpenseAnalysisResponseUnmarshaller.Create;
begin
  FInstance := TStartExpenseAnalysisResponseUnmarshaller.Create;
end;

class function TStartExpenseAnalysisResponseUnmarshaller.Instance: IStartExpenseAnalysisResponseUnmarshaller;
begin
  Result := FInstance;
end;

unit AWS.S3Control.Transform.GetBucketPolicyResponseUnmarshaller;
...
type
  ...
  strict private
    ...
    class procedure UnmarshallResult(AContext: TXmlUnmarshallerContext; AResponse: TGetBucketPolicyResponse); static;
...
class procedure TGetBucketPolicyResponseUnmarshaller.UnmarshallResult(AContext: TXmlUnmarshallerContext; AResponse: TGetBucketPolicyResponse);
var
